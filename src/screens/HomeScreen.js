...
const HomeScreen = ({ navigation }) => {
  ...
  // hardcoded ui elements. just for show
  const list = [
    {
      id: "0",
  ...
  useEffect(() => {
    ...
    // Check if products are already in AsyncStorage
    const getProductsFromStorage = async () => {
      try {
        ...
        if (storedProducts) {
          ...
          // Fetch from API if not found in AsyncStorage
          fetchData();
        }
      } catch (error) {
          ...
          >
            ...
            <Pressable 
              ...
              <Ionicon
                ...
                color="black"
              />
              <TextInput placeholder="Search in Fakestore..." />
            </Pressable>
            <Ionicon name="mic" size={24} color="black" />
          </View>
